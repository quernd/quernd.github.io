...
function view_of_location($$location) {
...
function init(_, $$location) {
  var match = view_of_location($$location);
  ...
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      ...
      case 4 : 
          ...
          break;
      case 5 : 
          var match$10 = view_of_location(param[0]);
          var newrecord$3 = model.slice();
          return /* tuple */[
                  (newrecord$3[/* view */6] = match$10[0], newrecord$3),
                  match$10[1]
                ];
      case 6 : 
          var id = param[0];
      ...
      case 8 : 
          ...
          var view = pgn ? /* Pgn */[pgn[0][0]] : /* Tournament */1;
          return /* tuple */[
                  /* record */[
                    /* position */model[/* position */0],
                    /* board */model[/* board */1],
...
function game_nav_view(model) {
  ...
  return nav(/* None */0, /* None */0, /* :: */[
              ...
              ul(/* None */0, /* None */0, /* [] */0, $at(/* :: */[
                        game_nav_item(+(model[/* view */6] === /* Game */0), "#/game", "Game"),
                        /* :: */[
                          game_nav_item(+(model[/* view */6] === /* Tournament */1), "#/tournament", "Tournament"),
                          /* [] */0
                        ]
                      ], rev_map((function (param) {
                              var id = param[0];
                              return li(/* None */0, /* None */0, /* :: */[
                                          caml_equal(model[/* view */6], /* Pgn */[id]) ? class$prime("current") : noProp$1,
                                          /* [] */0
                                        ], /* :: */[
                                          caml_equal(model[/* view */6], /* Pgn */[id]) ? text$1(id) : a(/* None */0, /* None */0, /* :: */[
                                                  href(_1(sprintf(/* Format */[
                                                                /* String_literal */__(11, [
                                                                    "#/pgn/",
                                                                    /* String */__(2, [
...
exports.proxy = proxy;
exports.view_of_location = view_of_location;
exports.init = init;
