...
function long_move(position, move) {
  if (typeof move === "number") {
    if (move) {
      return /* Qside_castle */0;
    } else {
      return /* Kside_castle */1;
    }
  } else if (move.tag) {
    var t_file = move[2];
    var s_file = move[1];
...
function unify_move(short_move, long_move) {
  if (typeof long_move === "number") {
    return /* false */0;
  } else if (long_move.tag) {
    return /* false */0;
  } else {
...
function san_of_move$prime(position, move_list, move) {
  ...
  } else if (typeof long_move$1 === "number") {
    san = long_move$1 ? "O-O" : "O-O-O";
  } else if (long_move$1.tag) {
...
var partial_arg$1 = cartesian_decoder("pageX", "pageY");

var size = Decoder[/* field */11]("clientWidth", Decoder[/* int */3]);

var partial_arg$2 = Decoder[/* map3 */18]((function (a$$1, b, c) {
        return /* tuple */[
                a$$1,
                b,
                c
...
function result_view(result) {
  var tmp;
  tmp = typeof result === "number" ? "The game is a draw!" : (
      result.tag ? _1(sprintf(/* Format */[
                  /* String_literal */__(11, [
                      "There are ",
                      /* Int */__(4, [
                          /* Int_d */0,
                  ...
                  "There are %d legal moves in this position!"
                ]), length(result[0])) : (
          result[0] !== 0 ? "White wins by checkmate!" : "Black wins by checkmate!"
        )
    );
  return p(/* None */0, /* None */0, /* [] */0, /* :: */[
              text$1(tmp),
              /* [] */0
            ]);
}
...
function view(model) {
  ...
  return div$2(/* None */0, /* None */0, /* [] */0, /* :: */[
              ...
              /* :: */[
                p(/* None */0, /* None */0, /* [] */0, $at(map((function (param) {
                ...
                /* :: */[
                  result_view(game_status$$1),
                  /* :: */[
                    move_list_view(model[/* ply */3], model[/* moves */2]),
                    /* [] */0
                  ]
                ]
              ]
