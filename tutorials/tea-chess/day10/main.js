...
function string_of_game(game) {
  var match = game[/* moves */0];
  var moves = rev_append(match[0], match[1]);
  var sans = map((function (prim) {
          return prim[1];
        }), moves);
  return concat$1(" ", sans) + " *";
}
...
function update$1(model, param) {
  if (typeof param === "number") {
    switch (param) {
      case 0 : 
          var match = game_status(model[/* position */1]);
          var tmp;
          if (typeof match === "number") {
            tmp = none;
          } else if (match.tag) {
            ...
            tmp = generate((function (random_number) {
                    return /* Make_move */__(0, [nth(move_list, random_number)]);
                  }), $$int(0, length(move_list)));
          } else {
            tmp = none;
          }
          return /* tuple */[
      ...
      case 1 : 
          var match$1 = model[/* position */1][/* prev */5];
          return /* tuple */[
                  match$1 ? /* record */[
                      /* moves */back(model[/* moves */0]),
                      /* position */match$1[0],
                      /* ply */model[/* ply */2] - 1 | 0
                    ] : model,
                  none
      ...
      case 2 : 
          try {
            var match$2 = fwd(model[/* moves */0]);
            return /* tuple */[
                    /* record */[
                      /* moves */match$2[1],
                      /* position */make_move(model[/* position */1], match$2[0][0]),
                      /* ply */model[/* ply */2] + 1 | 0
                    ],
                    none
                  ];
    ...
    if (how_many !== 0) {
      var match$3 = how_many > 0 ? jump_fwd(model[/* position */1], model[/* moves */0], how_many) : jump_back(model[/* position */1], model[/* moves */0], how_many);
      return /* tuple */[
              /* record */[
                /* moves */match$3[1],
                /* position */match$3[0],
                /* ply */model[/* ply */2] + how_many | 0
              ],
              none
            ];
    } else {
    ...
    var move = param[0];
    var san = san_of_move(model[/* position */1], move);
    return /* tuple */[
            /* record */[
              ...
              /* position */make_move(model[/* position */1], move),
              /* ply */model[/* ply */2] + 1 | 0
            ],
            none
          ];
  ...
  return li(/* None */0, /* None */0, /* :: */[
              ...
              /* :: */[
                span(/* None */0, /* None */0, /* :: */[
                      class$prime("move"),
                      /* :: */[
                        offset !== 0 ? onClick(/* Jump */__(1, [offset])) : noProp$1,
                        /* [] */0
                      ]
                    ], /* :: */[
                      text$1(param[1]),
...
function home_view(highlight, current_ply) {
  return li(/* None */0, /* None */0, /* :: */[
              ...
              span(/* None */0, /* None */0, /* :: */[
                    class$prime("move"),
                    /* :: */[
                      onClick(/* Jump */__(1, [-current_ply | 0])),
                      /* [] */0
                    ]
                  ], /* :: */[
                    text$1("\u2302"),
...
function view$1(model) {
  return ul(/* None */0, /* None */0, /* :: */[
              class$prime("moves"),
              /* [] */0
            ], move_list_view(model[/* ply */2], model[/* moves */0]));
}
...
function modify(l, f, a) {
  var value = _1(l[/* get */0], a);
  var new_value = _1(f, value);
  return _2(l[/* set */1], new_value, a);
}
...
function compose(l1, l2) {
  ...
  return /* record */[
          /* get */(function (param) {
              return _1(partial_arg, _1(partial_arg$1, param));
            }),
          /* set */(function (param) {
              var partial_arg$3 = _1(partial_arg$2, param);
              return (function (param) {
...
function pair$1(l1, l2) {
  return /* record */[
          ...
          /* set */(function (param, param$1) {
              return /* tuple */[
                      _2(l1[/* set */1], param[0], param$1[0]),
                      _2(l2[/* set */1], param[1], param$1[1])
                    ];
            })
        ];
}
...
function add$4(x, data, param) {
  if (param) {
    ...
    if (c) {
      if (c < 0) {
        return bal(add$4(x, data, l), v, d, r);
      } else {
        return bal(l, v, d, add$4(x, data, r));
      }
    } else {
      return /* Node */[
              l,
...
function remove$2(x, param) {
  if (param) {
    ...
    if (c) {
      if (c < 0) {
        return bal(remove$2(x, l), v, d, r);
      } else {
        return bal(l, v, d, remove$2(x, r));
      }
    } else {
      var t1 = l;
      var t2 = r;
...
function fold$1(f, _m, _accu) {
  while(true) {
    ...
    var m = _m;
    if (m) {
      _accu = _3(f, m[1], m[2], fold$1(f, m[0], accu));
      _m = m[3];
      continue ;
...
var $$int$2 = /* Decoder */[(function (value) {
      var match = classify(value);
      if (typeof match === "number") {
...
var $$float$2 = /* Decoder */[(function (value) {
      var match = classify(value);
      if (typeof match === "number") {
...
var bool$2 = /* Decoder */[(function (value) {
      var match = classify(value);
      if (typeof match === "number") {
        switch (match) {
          case 0 : 
...
function map3$1(mapper, param, param$1, param$2) {
  ...
  return /* Decoder */[(function (value) {
              ...
              if (exit$$1 === 1) {
                var match$3 = first$1(match$2, first$1(match$1, match));
                if (match$3.tag) {
...
function map4$1(mapper, param, param$1, param$2, param$3) {
  ...
  return /* Decoder */[(function (value) {
              ...
              if (exit$$1 === 1) {
                var match$4 = first$1(match$3, first$1(match$2, first$1(match$1, match)));
                if (match$4.tag) {
...
function map5$1(mapper, param, param$1, param$2, param$3, param$4) {
  ...
  return /* Decoder */[(function (value) {
              ...
              if (exit$$1 === 1) {
                var match$5 = first$1(match$4, first$1(match$3, first$1(match$2, first$1(match$1, match))));
                if (match$5.tag) {
...
function map6(mapper, param, param$1, param$2, param$3, param$4, param$5) {
  ...
  return /* Decoder */[(function (value) {
              ...
              if (exit$$1 === 1) {
                var match$6 = first$1(match$5, first$1(match$4, first$1(match$3, first$1(match$2, first$1(match$1, match)))));
                if (match$6.tag) {
...
function map7(mapper, param, param$1, param$2, param$3, param$4, param$5, param$6) {
  ...
  return /* Decoder */[(function (value) {
              ...
              if (exit$$1 === 1) {
                var match$7 = first$1(match$6, first$1(match$5, first$1(match$4, first$1(match$3, first$1(match$2, first$1(match$1, match))))));
                if (match$7.tag) {
...
function map8(mapper, param, param$1, param$2, param$3, param$4, param$5, param$6, param$7) {
  ...
  return /* Decoder */[(function (value) {
              ...
              if (exit$$1 === 1) {
                var match$8 = first$1(match$7, first$1(match$6, first$1(match$5, first$1(match$4, first$1(match$3, first$1(match$2, first$1(match$1, match)))))));
                if (match$8.tag) {
...
var size$1 = Decoder[/* field */11]("clientWidth", Decoder[/* int */3]);
...
var partial_arg$2$1 = Decoder[/* map3 */18]((function (a$$1, b, c) {
      ...
      }), cartesian_decoder("offsetX", "offsetY"), cartesian_decoder("pageX", "pageY"), Decoder[/* field */11]("target", size$1));
...
function target$1(orientation, drag) {
...
function adjust_coordinates(orientation, coordinates, drag) {
  ...
  newrecord[/* target */2] = target$1(orientation, drag);
  newrecord[/* coordinates */6] = coordinates;
  return newrecord;
}

function update$2(model, param) {
  if (param.tag) {
    return /* tuple */[
            model,
            none
        ...
        case 2 : 
            if (typeof match === "number") {
              ...
              if (match$1) {
                ...
                try {
                  var match$2 = assoc(target$$1, drag[/* legal_targets */3]);
                  if (match$2) {
                    return /* tuple */[
                            /* record */[
                              /* orientation */model[/* orientation */0],
...
var buttons_view_000$1 = button(/* None */0, /* None */0, /* :: */[
...
function board_view(interactable, pos_ar, model) {
  ...
  var rank_view = function (rank) {
    return node$1(/* None */0, "cb-row", /* None */0, /* None */0, /* [] */0, map((function (param) {
                      var rank$1 = rank;
                      var file = param;
                      var target_highlight = function (drag, target$$1) {
                        var match = drag[/* target */2];
                        if (match && caml_equal(match[0], target$$1)) {
                          return /* true */1;
                        } else {
                          return /* false */0;
                        }
                      };
                      var legal_highlight = function (drag, target$$1) {
                        return exists((function (param) {
                                      return caml_equal(param[0], target$$1);
...
function view$2(interactable, pos_ar, model) {
...
function andThen$2(fn, param) {
  var task = param[0];
  return /* Task */[(function (cb) {
              return _1(task, (function (err) {
                            if (err.tag) {
                              return _1(cb, err);
                            } else {
                              var match = _1(fn, err[0]);
                              return _1(match[0], cb);
                            }
                          }));
            })];
}

function map$9(func, task1) {
  return andThen$2((function (v1) {
                var value = _1(func, v1);
                return /* Task */[(function (cb) {
                            return _1(cb, /* Ok */__(0, [value]));
                          })];
              }), task1);
}

function map2$3(func, task1, task2) {
  return andThen$2((function (v1) {
                return andThen$2((function (v2) {
                              var value = _2(func, v1, v2);
                              return /* Task */[(function (cb) {
                                          return _1(cb, /* Ok */__(0, [value]));
                                        })];
                            }), task2);
...
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
var length$3 = /* Task */[(function (cb) {
      var match = length$4(window);
      if (match) {
...
var clear$2 = /* Task */[(function (cb) {
      var match = clear$3(window);
      if (match) {
        return _1(cb, /* Ok */__(0, [match[0]]));
      } else {
        return _1(cb, /* Error */__(1, ["localStorage is not available"]));
...
function removeItem(key) {
  return /* Task */[(function (cb) {
              var match = removeItem$1(window, key);
              if (match) {
                return _1(cb, /* Ok */__(0, [match[0]]));
              } else {
                return _1(cb, /* Error */__(1, ["localStorage is not available"]));
...
function setItem(key, value) {
  return /* Task */[(function (cb) {
              var match = setItem$1(window, key, value);
              if (match) {
                return _1(cb, /* Ok */__(0, [/* () */0]));
              } else {
                return _1(cb, /* Error */__(1, ["localStorage is not available"]));
...
var IntT = /* module */[/* compare */compare];

var compare$1 = caml_compare;

var StringT = /* module */[/* compare */compare$1];

var IntMap = Make(IntT);

var StringMap = Make(StringT);

function MapLens(Key) {
  var for_key = function (key) {
    var M = Make(Key);
    return /* record */[
            /* get */_1(M[/* find */21], key),
            /* set */_1(M[/* add */3], key)
          ];
  };
  return /* module */[/* for_key */for_key];
}

function for_key(key) {
  var M = Make(IntT);
  return /* record */[
          /* get */_1(M[/* find */21], key),
          /* set */_1(M[/* add */3], key)
...
var IntMapLens = /* module */[/* for_key */for_key];

function for_key$1(key) {
  var M = Make(StringT);
  return /* record */[
          /* get */_1(M[/* find */21], key),
          /* set */_1(M[/* add */3], key)
...
var StringMapLens = /* module */[/* for_key */for_key$1];

function local_lens_000(x) {
  return x[/* local_games */3];
}

function local_lens_001(v, x) {
  var newrecord = x.slice();
  newrecord[/* local_games */3] = v;
  return newrecord;
}

var local_lens = /* record */[
  local_lens_000,
  local_lens_001
];

function lichess_lens_000(x) {
  return x[/* lichess_games */5];
}

function lichess_lens_001(v, x) {
  var newrecord = x.slice();
  newrecord[/* lichess_games */5] = v;
  return newrecord;
}

var lichess_lens = /* record */[
  lichess_lens_000,
  lichess_lens_001
];

function scratch_lens_000(x) {
  return x[/* scratch_game */2];
}

function scratch_lens_001(v, x) {
  var newrecord = x.slice();
  newrecord[/* scratch_game */2] = v;
  return newrecord;
}

var scratch_lens = /* record */[
  scratch_lens_000,
  scratch_lens_001
];
...
function games_loaded(param_0) {
  return /* Games_loaded */__(3, [param_0]);
}
        ...
        switch (match[0]) {
          ...
          case "local" : 
              ...
              if (match$2 && !match$2[1]) {
                return /* Local */__(0, [caml_int_of_string(match$2[0])]);
              } else {
                return /* Scratch */0;
              }
          case "tournament" : 
...
function update_route(model, route) {
  if (caml_equal(model[/* route */6], route)) {
    return /* tuple */[
            model,
            none
          ];
    ...
    if (typeof route === "number") {
      ...
      var game_id = route[0];
      try {
        var id = _2(StringMap[/* find */21], game_id, model[/* lichess_games */5]);
        var game = Infix[/* |-- */3](local_lens, for_key(id));
        var route$1 = /* Local */__(0, [id]);
        return /* tuple */[
                /* record */[
                  /* game */game,
                  /* board */model[/* board */1],
                  /* scratch_game */model[/* scratch_game */2],
                  /* local_games */model[/* local_games */3],
                  /* tournament */model[/* tournament */4],
                  /* lichess_games */model[/* lichess_games */5],
                  /* route */route$1
                ],
                modifyUrl(location_of_route(route$1))
              ];
      }
      catch (exn){
        if (exn === not_found) {
          var key;
          try {
            key = _1(IntMap[/* max_binding */18], model[/* local_games */3])[0] + 1 | 0;
          }
          catch (exn$1){
            if (exn$1 === not_found) {
              key = 1;
          ...
          var game$1 = Infix[/* |-- */3](local_lens, for_key(key));
          var route$2 = /* Local */__(0, [key]);
          return /* tuple */[
                  /* record */[
                    /* game */game$1,
                    /* board */model[/* board */1],
                    ...
                    /* tournament */model[/* tournament */4],
                    /* lichess_games */_3(StringMap[/* add */3], game_id, key, model[/* lichess_games */5]),
                    /* route */route$2
                  ],
                  batch(/* :: */[
                        modifyUrl(location_of_route(route$2)),
                        /* :: */[
                          send((function (param) {
                                  return /* Pgn_data */__(7, [
                                            game$1,
      ...
      var id$1$$1 = route[0];
      if (_2(IntMap[/* mem */2], id$1$$1, model[/* local_games */3])) {
        var game$2 = Infix[/* |-- */3](local_lens, for_key(id$1$$1));
        return /* tuple */[
                /* record */[
                  /* game */game$2,
                  /* board */model[/* board */1],
...
var load_games = attemptOpt((function (param) {
        if (param.tag) {
          return /* None */0;
        } else {
          return /* Some */[/* Games_loaded */__(3, [param[0]])];
        }
      }), andThen$2((function (keys) {
            return sequence(map((function (key) {
                              return map$9((function (value$$1) {
                                            return /* tuple */[
                                                    key,
                                                    value$$1
                                                  ];
                                          }), LocalStorage[/* getItem */4](key));
                            }), keys));
          }), andThen$2((function (length$$1) {
                ...
                return sequence(loop(length$$1, /* [] */0));
              }), LocalStorage[/* length */0])));

var init_model_001 = /* board */init$7(/* () */0);

var init_model_002 = /* scratch_game */init$4(/* () */0);

var init_model_003 = /* local_games */IntMap[/* empty */0];

var init_model_005 = /* lichess_games */StringMap[/* empty */0];
...
function init(_, $$location) {
  var match = update_route(init_model, route_of_location($$location));
  return /* tuple */[
          match[0],
          batch(/* :: */[
                match[1],
...
function update(model, param) {
  if (typeof param === "number") {
    switch (param) {
      ...
      case 1 : 
          var match = _3(IntMap[/* fold */10], (function (key, game, param) {
                  var key$prime = string_of_int(key);
                  var pgn = string_of_game(game);
                  return /* tuple */[
                          /* :: */[
                            key$prime,
                            param[0]
                          ...
                          /* :: */[
                            LocalStorage[/* setItemCmd */8](key$prime, pgn),
                            param[1]
                          ]
                        ];
                }), model[/* local_games */3], /* tuple */[
                /* [] */0,
                /* [] */0
              ]);
          var games = concat$1(" ", match[0]);
          var cmd = LocalStorage[/* setItemCmd */8]("games", games);
          return /* tuple */[
                  model,
                  batch(/* :: */[
                        cmd,
      ...
      case 3 : 
          return /* tuple */[
                  /* record */[
                    ...
                    /* scratch_game */model[/* scratch_game */2],
                    /* local_games */model[/* local_games */3],
                    /* tournament : Loading */1,
                    /* lichess_games */model[/* lichess_games */5],
                    /* route : Tournament */1
                  ],
                  send(tournament_data, getString("https://lichess.org/api/tournament/GToVqkC9"))
                ];
    ...
    switch (param.tag | 0) {
      case 0 : 
          var msg$$1 = param[0];
          if (msg$$1.tag) {
            var match$1 = update$1(Infix[/* |. */0](model, model[/* game */0]), /* Make_move */__(0, [msg$$1[0]]));
            return /* tuple */[
                    Infix[/* ^= */1](model[/* game */0], match$1[0], model),
                    map$4(game_msg, match$1[1])
                  ];
          } else {
            var match$2 = update$2(model[/* board */1], msg$$1);
            var newrecord = model.slice();
            return /* tuple */[
                    (newrecord[/* board */1] = match$2[0], newrecord),
                    map$4(board_msg, match$2[1])
                  ];
          }
          break;
      case 1 : 
          var match$3 = update$1(Infix[/* |. */0](model, model[/* game */0]), param[0]);
          return /* tuple */[
                  Infix[/* ^= */1](model[/* game */0], match$3[0], model),
                  map$4(game_msg, match$3[1])
                ];
      case 2 : 
          var key_event$$1 = param[0];
          var match$4 = key_event$$1[/* ctrl */2];
          var match$5 = key_event$$1[/* key_code */0];
          var tmp;
          var exit$$1 = 0;
          if (match$4 !== 0) {
            if (match$5 !== 66) {
              if (match$5 >= 82) {
                if (match$5 >= 85) {
                  ...
                  switch (match$5 - 82 | 0) {
                    case 0 : 
                        tmp = msg(/* Game_msg */__(1, [/* Random_button */0]));
                        break;
                    case 1 : 
                        exit$$1 = 1;
                        break;
                    case 2 : 
                        tmp = msg(/* Game_msg */__(1, [/* Back_button */1]));
                        break;
                ...
                tmp = msg(/* Game_msg */__(1, [/* Fwd_button */2]));
              }
            } else {
              tmp = msg(/* Game_msg */__(1, [/* Back_button */1]));
            }
      ...
      case 3 : 
          var list = param[0];
          try {
            var games$1 = split_on_char(/* " " */32, assoc("games", list));
...
function game_nav_view(model) {
  ...
  var g = function (id, _, k) {
    var item = game_nav_item(caml_equal(model[/* route */6], /* Local */__(0, [id])), _1(sprintf(/* Format */[
                  /* String_literal */__(11, [
                      "#/local/",
                      /* Int */__(4, [
                          /* Int_d */0,
  ...
  return nav(/* None */0, /* None */0, /* :: */[
              ...
              ul(/* None */0, /* None */0, /* [] */0, /* :: */[
                    game_nav_item(+(model[/* route */6] === /* Scratch */0), "#/", "*scratch*"),
                    _4(IntMap[/* fold */10], g, model[/* local_games */3], (function (x) {
                            return x;
                          }), /* [] */0)
                  ]),
              /* [] */0
...
var buttons_view = nav(/* None */0, /* None */0, /* [] */0, /* :: */[
      button(/* None */0, /* None */0, /* :: */[
            onClick(/* New_tab */0),
            /* [] */0
          ], /* :: */[
      ...
      /* :: */[
        button(/* None */0, /* None */0, /* :: */[
              onClick(/* Save_games */1),
              /* [] */0
            ], /* :: */[
              text$1("save all games in local storage"),
              /* [] */0
            ]),
        /* :: */[
          button(/* None */0, /* None */0, /* :: */[
                onClick(/* Clear_games */2),
                /* [] */0
              ], /* :: */[
                text$1("clear local storage"),
                /* [] */0
              ]),
          /* :: */[
            button(/* None */0, /* None */0, /* :: */[
                  onClick(/* Load_tournament */3),
                  /* [] */0
                ], /* :: */[
                  text$1("load a game from Lichess"),
                  /* [] */0
                ]),
            /* [] */0
          ]
...
var scratch_view = div$2(/* None */0, /* None */0, /* [] */0, /* :: */[
      buttons_view,
      /* :: */[
        p(/* None */0, /* None */0, /* [] */0, /* :: */[
...
function view(model) {
  var game = Infix[/* |. */0](model, model[/* game */0]);
  var game_view = map$10(game_msg, view$1(game));
  var match = game_status(game[/* position */1]);
  var interactable$$1;
  interactable$$1 = typeof match === "number" || !match.tag ? /* Not_interactable */0 : /* Interactable */[
      game[/* position */1][/* turn */1],
      match[0]
    ];
  var match$1 = model[/* route */6];
  return main$3(/* None */0, /* None */0, /* [] */0, /* :: */[
              section(/* None */0, /* None */0, /* :: */[
                    ...
                    header_nav_view,
                    /* :: */[
                      map$10(board_msg, view$2(interactable$$1, game[/* position */1][/* ar */0], model[/* board */1])),
                      /* :: */[
                        nav(/* None */0, /* None */0, /* :: */[
                              id$1("buttons"),
                              /* [] */0
                            ], $at(map((function (param) {
                                        return map$10(board_msg, param);
                                      }), buttons_view$2), map((function (param) {
                                        return map$10(game_msg, param);
                                      }), buttons_view$1))),
                        /* [] */0
                      ]
                    ]
                      ...
                      /* :: */[
                        section(/* None */0, /* None */0, /* :: */[
                              ...
                              /* [] */0
                                ...
                                match$1 !== 0 ? /* :: */[
                                    tournament_view(model[/* tournament */4]),
                                    /* [] */0
                                  ] : /* :: */[
                                    scratch_view,
                                    /* :: */[
...
function subscriptions(model) {
  return batch$1(/* :: */[
              map$7(board_msg, subscriptions$1(model[/* board */1])),
              /* :: */[
...
var new_tab = /* New_tab */0;

var save_games = /* Save_games */1;

var clear_games = /* Clear_games */2;

var load_tournament = /* Load_tournament */3;
...
exports.IntMapLens = IntMapLens;
exports.StringMapLens = StringMapLens;
exports.local_lens = local_lens;
exports.lichess_lens = lichess_lens;
exports.scratch_lens = scratch_lens;
exports.board_msg = board_msg;
exports.game_msg = game_msg;
exports.key_pressed = key_pressed;
exports.new_tab = new_tab;
exports.save_games = save_games;
exports.clear_games = clear_games;
exports.games_loaded = games_loaded;
exports.load_tournament = load_tournament;
...
exports.location_of_route = location_of_route;
exports.update_route = update_route;
exports.load_games = load_games;
...
exports.scratch_view = scratch_view;
exports.view = view;
